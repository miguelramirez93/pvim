local M = {
    install_cfg = {{"lukas-reineke/indent-blankline.nvim"}},
    indent_blankline_char = "▏",
    show_hidden_chars = true
}
...
function M.setup()
    ...
    vim.g.indent_blankline_char = M.indent_blankline_char
    -- vim.g.indent_blankline_char = "▎"
    ...
    vim.opt.list = M.show_hidden_chars
    ...
    indent_blankline.setup({
        ...
        -- space_char_blankline = M.space_char_blankline
