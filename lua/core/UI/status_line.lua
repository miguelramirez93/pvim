local default_disabled_filetypes = {"alpha", "dashboard", "NvimTree", "Outline"}
local M = {
    disabled = false,
...
function M.setup()
    ...
    local disabled_filetypes = default_disabled_filetypes

    for _, d_filetype in ipairs(M.disabled_filetypes) do
        table.insert(disabled_filetypes, d_filetype)
    end
